# ---------------------------------------------------------------------------- #
#                      ANCHOR Inventory Mod Compatibility                      #
# ---------------------------------------------------------------------------- #
...
recipes.addShaped("vault_searcher", <vaultopic:vault_searcher>, [[<minecraft:redstone>, <ore:ingotBrick>, null],[<minecraft:brick>, <minecraft:redstone_torch>, null]]);
...
recipes.addShaped("block_extender", <refinedrelocation:block_extender>, [[<ore:ingotIron>, <ore:paneGlass>, <ore:ingotIron>],[<vaultopic:vault_searcher>, <refinedrelocation:sorting_connector>, <vaultopic:vault_searcher>], [<ore:ingotIron>, <ore:paneGlass>, <ore:ingotIron>]]);